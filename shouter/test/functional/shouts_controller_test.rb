...
class ShoutsControllerTest < ActionController::TestCase
  ...
  test "should create shout" do
    assert_difference('Shout.count') do
      post :create, shout: { shout_to_id: @shout.shout_to_id, text: @shout.text, user_id: @shout.user_id }
    end
  ...
  test "should update shout" do
    put :update, id: @shout, shout: { shout_to_id: @shout.shout_to_id, text: @shout.text, user_id: @shout.user_id }
    assert_redirected_to shout_path(assigns(:shout))
  end
